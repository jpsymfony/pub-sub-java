...
/**
 * The type Ihm avec save load.
 */
public class IHM_avec_SAVE_LOAD extends JFrame
{
    ...
    private JTextField fileName = new JTextField("mediator1.ser", 10);
    ...
    /**
     * Instantiates a new Ihm avec save load.
     */
    public IHM_avec_SAVE_LOAD()
    {
        ...
        panelTools.add(new JLabel(" file name :"));
        panelTools.add(fileName);
        panelTools.add(new JLabel(" mediator :"));
        panelTools.add(save);
        panelTools.add(new JLabel(" mediator :"));
        panelTools.add(load);
        ...
        this.topicsPanel.setLayout(new FlowLayout(FlowLayout.LEFT));
        ...
        this.save.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                try {
                    ...
                    oos.writeObject(mediator);
                    oos.writeObject(theTopic);
                    oos.writeObject(topics.keySet());
                    oos.close();
                    console.setText(name + " file saved\n");
                } catch (Exception e) {
                    console.append(stringStackTrace(e) + "\n");
                }
            }
        ...
        this.load.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                try {
                    ...
                    mediator = (Mediator) ois.readObject();
                    theTopic = (Topic) ois.readObject();
                    Set<String> topicsName = (Set) ois.readObject();
                    for (String cl : topicsName) {
                        topic.setText(topics.get(cl).toString());
                        loadTopic.doClick();
                    }


                    ois.close();
                    console.setText(name + " file loaded\n");
                    pack();
                } catch (Exception e) {
                    console.append(stringStackTrace(e) + "\n");
                }
